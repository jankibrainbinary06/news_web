                          ...
                          children: [
                            ...
                            dashboardController.isNewsDetail == false
                              ...
                              child: dashboardController.isNewsCategory
                                  ?  dashboardController.isLoading?const Center(child: CircularProgressIndicator()):Column(
                                crossAxisAlignment:
                                            ...
                                            DropdownButtonHideUnderline(
                                              child: DropdownButton(
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    dashboardController.imagedocid=snapshot.data!.docs[dashboardController.showNewsIndex!].id;
                                                  ...
                                                  List.generate(
                                                      ...
                                                      'subCategory']
                                                          ...
                                                          DropdownMenuItem(
                                                            ...
                                                            onTap:
                                                                () {
                                                              print(dashboardController.dropItems);
                                                              dashboardController.dropItems.forEach((element) {
                                                            ...
                                                            child:
                                                            Text(dashboardController.dropItems[y]['subCategory'][index]['Name'].toString()), // Convert the dynamic item to a string
                                                          ))),
                                            ),
                                          );
                                        },
                                        ...
                                        onTap: () async {
                                          ...
                                          await dashboardController
                                              ...
                                              dashboardController
                                                  .imageData!)
                                              .then((p0) async {
                                            dashboardController.url = await p0
                                                .ref
                                                .getDownloadURL();
                                            dashboardController.update(['news']);
                                          ...
                                          dashboardController.newsData.insert(
                                                  ...
                                                  .subIndex!,
                                              {
                                                ...
                                                "Data": {
                                                  ...
                                                  dashboardController
                                                      .description,
                                                  "ImageUrl":dashboardController.url,
                                                }
                                              });
