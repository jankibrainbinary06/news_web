         ...
         return StreamBuilder(
           ...
           builder: (context, snapshot) {
             if (snapshot.hasData) {
               ...
               print(data);
print("--------->${data['subcategory'][dashboardController.indexOfDropDown]['Data']['ImageUrl']}");
                       ...
                       children: [
                         ...
                         Container(
                           ...
                           decoration: BoxDecoration(
                             ...
                             //   fit: BoxFit.fill,
                             //   image: /*AssetImage(AssetRes.imagePicker)*/ NetworkImage( data['subcategory'][dashboardController.indexOfDropDown]['Data']['ImageUrl']),
                             // ),
                            ...
                            child: /*Image.network(data['subcategory'][dashboardController.indexOfDropDown]['Data']['ImageUrl'])*/CachedNetworkImage(
                              imageUrl: data['subcategory'][dashboardController.indexOfDropDown]['Data']['ImageUrl'],
